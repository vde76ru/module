...
router.post('/', authenticate, checkPermission('suppliers.create'), async (req, res) => {
  try {
    const { code, name, api_type, api_config, is_main, priority, description, contact_info, website, api_url, type } = req.body;
...
router.put('/:id', authenticate, checkPermission('suppliers.update'), async (req, res) => {
  try {
    const { code, name, api_type, api_config, is_main, priority, description, contact_info, website, api_url, type, status } = req.body;
