...
class ProductsAPI extends BaseAPIService {
  ...
  async createCategory(categoryData) {
    try {
      const response = await axios.post(API_ENDPOINTS.PRODUCTS_CATEGORIES, categoryData);
      const result = this.handleResponse(response);
  ...
  async updateCategory(id, categoryData) {
    try {
      const url = `${API_ENDPOINTS.PRODUCTS_CATEGORIES}/${id}`;
  ...
  async createBrand(brandData) {
    try {
      const response = await axios.post(API_ENDPOINTS.BRANDS, brandData);
      const result = this.handleResponse(response);
  ...
  async updateBrand(id, brandData) {
    try {
      const url = `${API_ENDPOINTS.BRANDS}/${id}`;
  ...
  async getAttributes() {
    try {
      const response = await axios.get(API_ENDPOINTS.DICTIONARIES_ATTRIBUTES);
      const result = this.handleResponse(response);
  ...
  async createAttribute(attributeData) {
    try {
      const response = await axios.post(API_ENDPOINTS.DICTIONARIES_ATTRIBUTES, attributeData);
      const result = this.handleResponse(response);
  ...
  async updateAttribute(id, attributeData) {
    try {
      const url = `${API_ENDPOINTS.DICTIONARIES_ATTRIBUTES}/${id}`;
      const response = await axios.put(url, attributeData);
      const result = this.handleResponse(response);
      ...
      throw new Error(result.error || 'Failed to update attribute');
    } catch (error) {
      throw this.handleError(error);
    }
  }
...
class WarehousesAPI extends BaseAPIService {
  ...
  // ===== Компоненты мульти-склада =====
  async getComponents(warehouseId) {
    try {
      const url = this.replaceUrlParams(API_ENDPOINTS.WAREHOUSE_DETAILS, { id: warehouseId }) + '/components';
      const response = await axios.get(url);
      const result = this.handleResponse(response);
      if (result.success) return result.data || [];
  ...
  async addComponent(warehouseId, componentWarehouseId, weight = 1) {
    try {
      const url = this.replaceUrlParams(API_ENDPOINTS.WAREHOUSE_DETAILS, { id: warehouseId }) + '/components';
      const response = await axios.post(url, { source_warehouse_id: componentWarehouseId, weight });
      const result = this.handleResponse(response);
  ...
  async removeComponent(warehouseId, componentWarehouseId) {
    try {
      const base = this.replaceUrlParams(API_ENDPOINTS.WAREHOUSE_DETAILS, { id: warehouseId });
      const url = `${base}/components/${componentWarehouseId}`;
      const response = await axios.delete(url);
      const result = this.handleResponse(response);
      if (result.success) return true;
...
// HEALTH API
// =====================================
class HealthAPI extends BaseAPIService {
  async getHealth() {
    try {
      const response = await axios.get(API_ENDPOINTS.HEALTH);
      return response.data; // health endpoints are plain JSON without {success}
    } catch (error) {
      throw this.handleError(error);
    }
  }
  ...
  async getLive() {
    try {
      const response = await axios.get(API_ENDPOINTS.HEALTH_LIVE);
  ...
  async getReady() {
    try {
      const response = await axios.get(API_ENDPOINTS.HEALTH_READY);
      return response.data;
    } catch (error) {
      throw this.handleError(error);
    }
...
// INTEGRATIONS API
// =====================================
class IntegrationsAPI extends BaseAPIService {
  /**
   * Тестирование подключения к RS24
   */
  async testRS24(credentials) {
    try {
      const response = await axios.post(API_ENDPOINTS.INTEGRATIONS_TEST_RS24, credentials);
      return this.handleResponse(response);
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  /**
   * Тестирование подключения к Yandex.Market
   */
  async testYandex(credentials) {
    try {
      const response = await axios.post(API_ENDPOINTS.INTEGRATIONS_TEST_YANDEX, credentials);
      return this.handleResponse(response);
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  /**
   * Сохранение настроек RS24
   */
  async saveRS24(settings) {
    try {
      const response = await axios.post(API_ENDPOINTS.INTEGRATIONS_SAVE_RS24, settings);
      return this.handleResponse(response);
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  /**
   * Сохранение настроек Yandex.Market
   */
  async saveYandex(settings) {
    try {
      const response = await axios.post(API_ENDPOINTS.INTEGRATIONS_SAVE_YANDEX, settings);
      return this.handleResponse(response);
    } catch (error) {
      throw this.handleError(error);
    }
   ...
   */
  async startSync(type, options = {}) {
    try {
      const response = await axios.post(API_ENDPOINTS.INTEGRATIONS_START_SYNC, {
        type,
        ...options
      });
      return this.handleResponse(response);
...
// JOBS API (Scheduler)
// =====================================
class JobsAPI extends BaseAPIService {
  async getSchedules(params = {}) {
    try {
      const response = await axios.get(API_ENDPOINTS.JOBS_SCHEDULES, { params });
      return this.handleResponse(response);
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  async createSchedule(payload) {
    try {
      const response = await axios.post(API_ENDPOINTS.JOBS_SCHEDULES, payload);
      return this.handleResponse(response);
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  async updateSchedule(id, payload) {
    try {
      const url = `${API_ENDPOINTS.JOBS_SCHEDULES}/${id}`;
  ...
  async runNow({ job, schedule_type } = {}) {
    try {
      const response = await axios.post(API_ENDPOINTS.JOBS_RUN_NOW, { job, schedule_type });
      return this.handleResponse(response);
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  async startScheduler() {
    try {
      const response = await axios.post(API_ENDPOINTS.JOBS_START);
      return this.handleResponse(response);
    } catch (error) {
      throw this.handleError(error);
    }
  ...
  async stopScheduler() {
    try {
      const response = await axios.post(API_ENDPOINTS.JOBS_STOP);
      return this.handleResponse(response);
    } catch (error) {
      throw this.handleError(error);
    }
