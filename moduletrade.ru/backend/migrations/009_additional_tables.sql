...
COMMENT ON COLUMN sync_logs.details IS 'Детали синхронизации';
...
COMMENT ON COLUMN sync_logs.records_processed IS 'Количество обработанных записей';
COMMENT ON COLUMN sync_logs.records_success IS 'Количество успешно обработанных записей';
COMMENT ON COLUMN sync_logs.records_failed IS 'Количество записей с ошибками';
...
COMMENT ON COLUMN api_logs.status_code IS 'HTTP статус код';
COMMENT ON COLUMN api_logs.response_time IS 'Время ответа в миллисекундах';
...
CREATE INDEX idx_api_logs_response_time ON api_logs (response_time);
