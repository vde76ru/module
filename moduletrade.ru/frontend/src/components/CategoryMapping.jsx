    ...
    const SystemCategory = ({ category }) => {
        ...
        return (
            <div ref={setNodeRef} style={style}>
                ...
                {Array.isArray(mappedSupplierCategories) && mappedSupplierCategories.length > 0 && (
                    <div style={{ marginTop: 8 }}>
                        <Divider style={{ margin: '8px 0' }} />
                        <div style={{ fontSize: '12px', color: '#666', marginBottom: 8 }}>
                            Связанные категории поставщика:
                        </div>
                        {Array.isArray(mappedSupplierCategories) ? mappedSupplierCategories.map(cat => (
                            <Tag
                                key={cat.id}
                                closable
        ...
        Modal.info({
            ...
            content: (
                <Select
                    ...
                    options={Array.isArray(unmappedCategories) ? unmappedCategories.map(cat => ({
                        label: cat.name,
                        value: cat.id
                    })) : []}
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                            ...
                            >
                                <div style={{ maxHeight: 600, overflowY: 'auto' }}>
                                    {Array.isArray(supplierCategories) ? supplierCategories
                                        .filter(cat =>
