...
ALTER TABLE products ADD CONSTRAINT IF NOT EXISTS products_sku_unique_per_company
    UNIQUE (company_id, sku);
ALTER TABLE products ADD CONSTRAINT IF NOT EXISTS products_barcode_unique_per_company
    UNIQUE (company_id, barcode);
ALTER TABLE products ADD CONSTRAINT IF NOT EXISTS products_slug_unique_per_company
...
ALTER TABLE product_mappings ADD CONSTRAINT IF NOT EXISTS product_mappings_unique
