...
ALTER TABLE companies
    ADD CONSTRAINT ck_companies_public_id CHECK (public_id IS NULL OR public_id >= 100000);
CREATE UNIQUE INDEX IF NOT EXISTS uq_companies_public_id ON companies (public_id) WHERE public_id IS NOT NULL;

CREATE TRIGGER assign_companies_public_id
...
ALTER TABLE users
    ADD CONSTRAINT ck_users_public_id CHECK (public_id IS NULL OR public_id >= 100000);
CREATE UNIQUE INDEX IF NOT EXISTS uq_users_company_public_id ON users (company_id, public_id) WHERE public_id IS NOT NULL;

CREATE TRIGGER assign_users_public_id
...
ALTER TABLE payments
    ADD CONSTRAINT ck_payments_public_id CHECK (public_id IS NULL OR public_id >= 100000);
CREATE UNIQUE INDEX IF NOT EXISTS uq_payments_company_public_id ON payments (company_id, public_id) WHERE public_id IS NOT NULL;

CREATE TRIGGER assign_payments_public_id
...
ALTER TABLE billing_accounts
    ADD CONSTRAINT ck_billing_accounts_public_id CHECK (public_id IS NULL OR public_id >= 100000);
CREATE UNIQUE INDEX IF NOT EXISTS uq_billing_accounts_company_public_id ON billing_accounts (company_id, public_id) WHERE public_id IS NOT NULL;

CREATE TRIGGER assign_billing_accounts_public_id
...
ALTER TABLE billing_transactions
    ADD CONSTRAINT ck_billing_transactions_public_id CHECK (public_id IS NULL OR public_id >= 100000);
CREATE UNIQUE INDEX IF NOT EXISTS uq_billing_transactions_public_id ON billing_transactions (public_id) WHERE public_id IS NOT NULL;

CREATE TRIGGER assign_billing_transactions_public_id
