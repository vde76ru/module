...
export const API_ENDPOINTS = {
  ...
  BRANDS: '/api/dictionaries/brands',
  ...
  PRODUCTS_CATEGORIES: '/api/dictionaries/categories',

  // Склады
  WAREHOUSES: '/api/dictionaries/warehouses',
  ...
  // Поставщики
  SUPPLIERS: '/api/dictionaries/suppliers',
  ...
  // Интеграции
  INTEGRATIONS_TEST_RS24: '/api/integrations/rs24/test',
  INTEGRATIONS_TEST_YANDEX: '/api/integrations/yandex/test',
  INTEGRATIONS_SAVE_RS24: '/api/integrations/rs24/save',
  INTEGRATIONS_SAVE_YANDEX: '/api/integrations/yandex/save',
  INTEGRATIONS_START_SYNC: '/api/integrations/sync/start',

  // Аудит
  AUDIT_LOGS: '/api/audit',
  AUDIT_EXPORT: '/api/audit/export/:format',
  ...
  // Задачи/Планировщик
  JOBS_SCHEDULES: '/api/jobs/schedules',
  JOBS_RUN_NOW: '/api/jobs/run-now',
  JOBS_START: '/api/jobs/start',
  JOBS_STOP: '/api/jobs/stop',
};
