...
INSERT INTO products (id, company_id, name, description, sku, brand_id, category_id, status, is_active) VALUES 
('00000000-0000-0000-0000-000000000040', '00000000-0000-0000-0000-000000000031', 'iPhone 15 Pro', 'Смартфон Apple iPhone 15 Pro', 'IPHONE-15-PRO', '00000000-0000-0000-0000-000000000037', '00000000-0000-0000-0000-000000000034', 'active', true),
('00000000-0000-0000-0000-000000000041', '00000000-0000-0000-0000-000000000031', 'Samsung Galaxy S24', 'Смартфон Samsung Galaxy S24', 'SAMSUNG-S24', '00000000-0000-0000-0000-000000000038', '00000000-0000-0000-0000-000000000034', 'active', true),
('00000000-0000-0000-0000-000000000042', '00000000-0000-0000-0000-000000000031', 'Nike Air Max', 'Кроссовки Nike Air Max', 'NIKE-AIR-MAX', '00000000-0000-0000-0000-000000000039', '00000000-0000-0000-0000-000000000035', 'active', true)
ON CONFLICT DO NOTHING;

-- Создаем демонстрационные цены
INSERT INTO prices (id, product_id, price_type, price, currency, is_active) VALUES 
('00000000-0000-0000-0000-000000000043', '00000000-0000-0000-0000-000000000040', 'retail', 129990.00, 'RUB', true),
('00000000-0000-0000-0000-000000000044', '00000000-0000-0000-0000-000000000041', 'retail', 89990.00, 'RUB', true),
('00000000-0000-0000-0000-000000000045', '00000000-0000-0000-0000-000000000042', 'retail', 15990.00, 'RUB', true)
ON CONFLICT DO NOTHING;
