...
const WarehouseForm = ({ warehouse, visible, onClose, onSuccess }) => {
  ...
  const warehouseTypes = [
    { value: 'warehouse', label: 'Склад', description: 'Склад хранения', icon: <ShopOutlined /> },
    { value: 'store', label: 'Магазин', description: 'Точка продаж', icon: <ShopOutlined /> },
    { value: 'pickup_point', label: 'Пункт выдачи', description: 'ПВЗ', icon: <ShopOutlined /> },
    { value: 'virtual', label: 'Виртуальный склад', description: 'Без физ. местоположения', icon: <CloudOutlined /> },
  ];
    ...
    >
      ...
      >
        ...
        <Form.Item label="Тип склада">
          <Select value={warehouseType} onChange={handleTypeChange} size="large">
