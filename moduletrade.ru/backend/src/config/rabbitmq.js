...
const rabbitmqConfig = {
  ...
  password: process.env.RABBITMQ_PASS || 'SecureRabbitPass2025',
...
async function createConnection() {
  try {
    ...
    const url = `amqp://${rabbitmqConfig.username}:${rabbitmqConfig.password}@${rabbitmqConfig.hostname}:${rabbitmqConfig.port}${rabbitmqConfig.vhost}`;
