...
ALTER TABLE warehouses
    ADD CONSTRAINT ck_warehouses_public_id CHECK (public_id IS NULL OR public_id >= 100000);
CREATE UNIQUE INDEX IF NOT EXISTS uq_warehouses_company_public_id ON warehouses (company_id, public_id) WHERE public_id IS NOT NULL;

CREATE TRIGGER assign_warehouses_public_id
...
ALTER TABLE warehouse_product_links
    ADD CONSTRAINT ck_warehouse_product_links_public_id CHECK (public_id IS NULL OR public_id >= 100000);
CREATE UNIQUE INDEX IF NOT EXISTS uq_warehouse_product_links_public_id ON warehouse_product_links (public_id) WHERE public_id IS NOT NULL;

CREATE TRIGGER assign_warehouse_product_links_public_id
    BEFORE INSERT ON warehouse_product_links
    FOR EACH ROW
...
ALTER TABLE warehouse_movements
    ADD CONSTRAINT ck_warehouse_movements_public_id CHECK (public_id IS NULL OR public_id >= 100000);
CREATE UNIQUE INDEX IF NOT EXISTS uq_warehouse_movements_public_id ON warehouse_movements (public_id) WHERE public_id IS NOT NULL;

CREATE TRIGGER assign_warehouse_movements_public_id
...
ALTER TABLE stock_reservations
    ADD CONSTRAINT ck_stock_reservations_public_id CHECK (public_id IS NULL OR public_id >= 100000);
CREATE UNIQUE INDEX IF NOT EXISTS uq_stock_reservations_public_id ON stock_reservations (public_id) WHERE public_id IS NOT NULL;

CREATE TRIGGER assign_stock_reservations_public_id
...
ALTER TABLE stock_transfers
    ADD CONSTRAINT ck_stock_transfers_public_id CHECK (public_id IS NULL OR public_id >= 100000);
CREATE UNIQUE INDEX IF NOT EXISTS uq_stock_transfers_company_public_id ON stock_transfers (company_id, public_id) WHERE public_id IS NOT NULL;

CREATE TRIGGER assign_stock_transfers_public_id
...
ALTER TABLE stock_transfer_items
    ADD CONSTRAINT ck_stock_transfer_items_public_id CHECK (public_id IS NULL OR public_id >= 100000);
CREATE UNIQUE INDEX IF NOT EXISTS uq_stock_transfer_items_public_id ON stock_transfer_items (public_id) WHERE public_id IS NOT NULL;

CREATE TRIGGER assign_stock_transfer_items_public_id
