...
CREATE INDEX idx_marketplace_settings_company_id ON marketplace_settings (company_id);
...
CREATE INDEX idx_procurement_overrides_product_id ON procurement_overrides (product_id);
CREATE INDEX idx_procurement_overrides_supplier_id ON procurement_overrides (supplier_id);
CREATE INDEX idx_procurement_overrides_type ON procurement_overrides (override_type);
CREATE INDEX idx_procurement_overrides_is_active ON procurement_overrides (is_active);
